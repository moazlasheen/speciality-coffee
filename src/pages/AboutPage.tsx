    ...
    <main className="pt-24 md:pt-28">
      ...
      <section className="relative py-22 md:py-34 grain-overlay overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-roast-500/75" />
        </div>
        <div className="relative z-10 max-w-[1400px] mx-auto px-5 md:px-8">
          <div className="max-w-2xl">
            ...
            <h1 className="font-serif text-display text-cream-100 mb-6 text-balance">
              Roasted with<br /><em className="text-ember-200">intention</em>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <RevealSection delay={150}>
              <div>
                ...
                <h2 className="font-serif text-h1 text-roast-500 mb-6">
                  Terroir over trend
                </h2>
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-5 md:px-8">
          <RevealSection>
            <div className="text-center mb-14">
              ...
              <h2 className="font-serif text-h1 text-roast-500">Our commitments</h2>
            </div>
          </RevealSection>
            ...
            {[
              ...
              <RevealSection key={title} delay={i * 100}>
                <div className="p-6 md:p-8">
                  <div className="w-10 h-10 bg-ember-50 rounded-full flex items-center justify-center mb-5">
                    <Icon className="w-5 h-5 text-ember-300" />
                  </div>
                  <h3 className="font-serif text-h4 text-roast-500 mb-3">{title}</h3>
                  <p className="text-body-sm font-sans text-charcoal-300 leading-relaxed">{text}</p>
                </div>
              </RevealSection>
            ))}
          </div>
      ...
      <section className="py-18 md:py-30">
        <div className="max-w-[1400px] mx-auto px-5 md:px-8">
          <RevealSection>
            ...
            <h2 className="font-serif text-h1 text-roast-500 mb-14">From cherry to cup</h2>
          </RevealSection>
            ...
            {[
              ...
              <RevealSection key={item.step} delay={i * 120}>
                <div className="group">
                  ...
                  <span className="text-caption text-ember-300 font-sans font-medium tracking-[0.15em]">{item.step}</span>
                  <h3 className="font-serif text-h3 text-roast-500 mt-2 mb-3">{item.title}</h3>
                  <p className="text-body-sm font-sans text-charcoal-300 leading-relaxed">{item.text}</p>
                </div>
              </RevealSection>
            ))}
          </div>
      ...
      {/* Team */}
      <section className="py-18 md:py-30 bg-roast-500 grain-overlay">
        <div className="relative z-10 max-w-[1400px] mx-auto px-5 md:px-8">
          <RevealSection>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, i) => (
              <RevealSection key={member.name} delay={i * 100}>
                <div className="group">
                  <div className="aspect-[3/4] bg-roast-400 rounded-sm overflow-hidden mb-5">
                    <img
                      src={member.image}
                      alt={member.name}
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  ...
                  <p className="text-body-sm font-sans text-cream-400/60 mt-1">{member.role}</p>
                </div>
              </RevealSection>
            ))}
          </div>
      ...
      <section className="py-18 md:py-30">
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 text-center">
          <RevealSection>
            <h2 className="font-serif text-h1 text-roast-500 mb-4">Ready to taste the difference?</h2>
            <p className="text-body-lg font-sans text-charcoal-300 max-w-lg mx-auto mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2.5 px-7 py-4 border border-roast-400 text-roast-500 font-sans font-medium text-sm uppercase tracking-[0.08em] rounded-sm hover:bg-roast-500 hover:text-cream-100 transition-colors"
              >
