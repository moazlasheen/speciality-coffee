    ...
    <main className="pt-24 md:pt-28 pb-18 md:pb-30">
      <div className="max-w-[1400px] mx-auto px-5 md:px-8">
        ...
        <div className="mb-10 md:mb-14">
          ...
          <h1 className="font-serif text-h1 text-roast-500 mb-4">Stories, guides & education</h1>
          ...
          >
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-caption text-charcoal-200 font-sans">{featured.readTime}</span>
              </div>
              <h2 className="font-serif text-h2 text-roast-500 mb-4 group-hover:text-ember-400 transition-colors">
                {featured.title}
              </h2>
              ...
              <div className="flex items-center gap-3">
                <span className="text-body-sm font-sans font-medium text-roast-500">{featured.author}</span>
                <span className="text-caption text-charcoal-200 font-sans">{featured.date}</span>
              </div>
            </div>
          </article>
        </RevealSection>
          ...
          {filtered.map((post, i) => (
            <RevealSection key={post.id} delay={i * 80}>
              <article className="group cursor-pointer">
                ...
                <p className="text-body-sm font-sans text-charcoal-300 line-clamp-2 mb-3">
                  {post.excerpt}
                </p>
                <div className="flex items-center gap-3">
                  <span className="text-caption font-sans font-medium text-roast-400">{post.author}</span>
                  <span className="text-caption text-charcoal-200 font-sans">{post.date}</span>
                </div>
              </article>
            </RevealSection>
          ))}
